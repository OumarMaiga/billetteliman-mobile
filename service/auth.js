...
export const login = async(payload) => {
    ...
    try {
        const response = await fetch(`${global.SERVER_ADDRESS}/login/log-me/?from-mobile`, {
            method: 'POST',
            headers: {
...
export const register = async(payload) => {
    ...
    try {
        const response = await fetch(`${global.SERVER_ADDRESS}/register/try/?from-mobile`, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
...
export const updateUser = async(user_id, payload) => {
    ...
    try {
        const response = await fetch(`${global.SERVER_ADDRESS}/user/update/${user_id}/?from-mobile`, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
...
export const changePassword = async(user_id, payload) => {
    ...
    try {
        const response = await fetch(`${global.SERVER_ADDRESS}/user/password/change/${user_id}/?from-mobile`, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
